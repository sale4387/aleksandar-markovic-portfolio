  ...
  projects: [
    {
      ...
      shortDescription: "A Telegram-first decision assistant that turns everyday questions into goals, constraints, options, pros and cons, next steps and an assessment.",
      problem: "Small everyday decisions often happen in messy chat-like context, without a clear structure for trade-offs, constraints or next actions.",
      workflow: ["Telegram question", "Goal extraction", "Constraints", "Options", "Pros & cons", "Next steps + assessment"],
      outcome: "Demonstrates AI-assisted decision support inside a familiar chat interface, turning messy questions into structured reasoning without a separate dashboard.",
      tags: ["Python", "Telegram Bot", "AI/LLM", "Decision Support"],
      ...
      coverSupportingLabels: ["Telegram decision chat", "Pros, cons & next steps"],
      coverSupportingDetails: ["Help Me Choose bot", "Goal · constraints · options · assessment"],
      screenshots: [
      ...
      productStory: {
        ...
        steps: [
          { label: "Telegram question", input: "Should I cook Chinese food at home or order via Uber Eats?" },
          { label: "Goal", output: "Decide between cooking Chinese food at home or ordering via Uber Eats." },
          { label: "Constraints", meta: ["Time availability", "Ingredient inventory", "Energy levels", "Budget"] },
          { label: "Options", meta: ["Cook at home", "Order Uber Eats"] },
          { label: "Pros & cons", output: "Cook at home: cheaper and healthier control. Order Uber Eats: convenient and no cleanup, but higher cost and less control." },
          { label: "Next steps + assessment", output: "Check ingredients, current energy level and delivery budget before deciding. Quality: good.", finalNote: "Synthetic portfolio walkthrough" },
        ],
      },
    },
    {
      ...
      outcome: "Demonstrates a real-world AI-assisted automation flow: deterministic solar-window calculation, live energy context, Telegram interaction and practical household recommendations.",
      tags: ["Python", "FastAPI", "Telegram Bot", "Firebase", "AI/LLM", "LangSmith"],
      ...
      coverSupportingLabels: ["Telegram assistant", "Solar windows"],
      coverSupportingDetails: ["Now · Ask AI · Window actuals", "Today until 17:00 · tomorrow 10:00–18:00"],
      screenshots: [
      ...
      productStory: {
        ...
        steps: [
          { label: "Telegram question", input: "When can I use washing machine?" },
          { label: "Live energy snapshot", meta: ["Grid import: 1311 W", "Solar production: 590 W", "House usage: 1901 W", "Solar to house: 590 W"] },
          { label: "Weather forecast", meta: ["Open-Meteo forecast loaded", "Productive sunlight until 17:00", "Tomorrow has a longer window"] },
          { label: "Solar windows", loadingText: "Checking forecast and live energy context...", loadingDetail: "Deterministic logic calculates the usable windows; AI explains the result but does not control devices." },
          { label: "AI answer", output: "Today has a productive window available until 17:00. Tomorrow offers a much better 8-hour opportunity from 10:00 to 18:00." },
          { label: "Telegram menu", meta: ["Now", "Solar windows", "Window actuals", "Ask AI", "Help", "Invite member"], output: "The bot keeps energy actions available from Telegram and supports private invite links for household members.", finalNote: "Synthetic portfolio walkthrough" },
        ],
      },
    },
    {
      ...
      tags: ["Python", "Streamlit", "AI/LLM", "Validation", "PDF", "LangSmith"],
    ...
    },
    {
      ...
      tags: ["Python", "Google APIs", "SERP Research", "AI/LLM", "Automation", "LangSmith"],
