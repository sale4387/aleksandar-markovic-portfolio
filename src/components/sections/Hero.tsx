...
export function Hero() {
  ...
  return (
    <section id="about" className="scroll-mt-20 overflow-hidden rounded-[28px] border border-slate-300/90 bg-[radial-gradient(circle_at_82%_18%,rgba(157,177,207,0.78),transparent_30%),radial-gradient(circle_at_12%_84%,rgba(191,204,220,0.82),transparent_25%),linear-gradient(135deg,#e3e9f1,#d4deea)] px-6 py-16 shadow-[0_12px_30px_rgba(15,23,42,0.05)] sm:px-8 sm:py-20 lg:px-12 lg:py-24">
